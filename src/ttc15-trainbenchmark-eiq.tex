...
%\ttcfig{architecture}{The architecture of the solution}{0.6}
...
\ttcpattern{pattern-routesensor}{Pattern of the \textsf{RouteSensor} query}
...
\ttcfig{rete-routesensor}{The Rete network for the \textsf{RouteSensor} query}{0.9}
...
\ttcfig{searchplan-routesensor}{The search plan and the matches for the \textsf{RouteSensor} query}{0.7}
